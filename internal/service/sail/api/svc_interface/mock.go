...
func (m *MockPublishSystem) DecryptPublishContent(ctx context.Context, pContent string) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DecryptPublishContent", ctx, pContent)
	ret0, _ := ret[0].(string)
	return ret0
}
...
func (mr *MockPublishSystemMockRecorder) DecryptPublishContent(ctx, pContent interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DecryptPublishContent", reflect.TypeOf((*MockPublishSystem)(nil).DecryptPublishContent), ctx, pContent)
}
...
func (m *MockPublishSystem) IsInPublish(ctx context.Context, projectKey, namespaceName string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsInPublish", ctx, projectKey, namespaceName)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPublishSystemMockRecorder) IsInPublish(ctx, projectKey, namespaceName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsInPublish", reflect.TypeOf((*MockPublishSystem)(nil).IsInPublish), ctx, projectKey, namespaceName)
}
