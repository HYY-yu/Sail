...
func (m *MockPublishSystem) DeletePublish(ctx context.Context, projectID, namespaceID, newStatus int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeletePublish", ctx, projectID, namespaceID, newStatus)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockPublishSystemMockRecorder) DeletePublish(ctx, projectID, namespaceID, newStatus interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletePublish", reflect.TypeOf((*MockPublishSystem)(nil).DeletePublish), ctx, projectID, namespaceID, newStatus)
}
...
func (m *MockPublishSystem) ListPublishConfig(ctx context.Context, projectID, namespaceID int) ([]model.PublishConfig, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPublishConfig", ctx, projectID, namespaceID)
...
func (mr *MockPublishSystemMockRecorder) ListPublishConfig(ctx, projectID, namespaceID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPublishConfig", reflect.TypeOf((*MockPublishSystem)(nil).ListPublishConfig), ctx, projectID, namespaceID)
}
...
// DecryptConfigContent mocks base method.
func (m *MockConfigSystem) DecryptConfigContent(content, namespaceKey string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DecryptConfigContent", content, namespaceKey)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DecryptConfigContent indicates an expected call of DecryptConfigContent.
func (mr *MockConfigSystemMockRecorder) DecryptConfigContent(content, namespaceKey interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DecryptConfigContent", reflect.TypeOf((*MockConfigSystem)(nil).DecryptConfigContent), content, namespaceKey)
}

// EncryptConfigContent mocks base method.
func (m *MockConfigSystem) EncryptConfigContent(content, namespaceKey string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EncryptConfigContent", content, namespaceKey)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// EncryptConfigContent indicates an expected call of EncryptConfigContent.
func (mr *MockConfigSystemMockRecorder) EncryptConfigContent(content, namespaceKey interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EncryptConfigContent", reflect.TypeOf((*MockConfigSystem)(nil).EncryptConfigContent), content, namespaceKey)
}
