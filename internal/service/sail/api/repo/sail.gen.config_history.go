...
// Tx 开启事务会话
func (obj *_ConfigHistoryMgr) Tx(tx *gorm.DB) *_ConfigHistoryMgr {
...
func (obj *_ConfigHistoryMgr) WithPrepareStmt() {
...
func (obj *_ConfigHistoryMgr) Count() (count int64, err error) {
